...
//       try {
//         const [servicesRes, ownersRes, testimonialsRes, statsRes] = await Promise.all([
//           axios.get(`${BACKEND_URL}/api/admin/services/featured`),
...
//         ]);
//         setFeaturedServices(servicesRes.data.data.services.slice(0, 6)); // Top 6 featured services
//         setBusinessOwners(ownersRes.data.data.owners.slice(0, 4)); // Top 4 business owners
//         setTestimonials(testimonialsRes.data.data.slice(0, 3)); // Top 3 testimonials
...
//             Discover a wide range of services from top business owners, book with ease, and experience seamless convenience.
//           </p>
//           <motion.button
...
//           <h2 className="text-3xl md:text-4xl font-bold text-center mb-10">Featured Services</h2>
...
//                 initial={{ opacity: 0, y: 20 }}
//                 animate={{ opacity: 1, y: 0 }}
//                 transition={{ duration: 0.5, delay: 0.1 * featuredServices.indexOf(service) }}
...
//                 <p className="text-sm text-gray-500">Available at: {service.location.join(', ')}</p>
//               </motion.div>
//             ))}
//           </div>
//         </div>
...
//                 initial={{ opacity: 0, y: 20 }}
//                 animate={{ opacity: 1, y: 0 }}
//                 transition={{ duration: 0.5, delay: 0.1 * testimonials.indexOf(testimonial) }}
